    ...
    <>
      ...
      <footer className="lg:hidden fixed z-30 bottom-0 bg-customRed flex items-center justify-between w-full h-16 px-3 sm:px-10">
        ...
        >
          ...
          <p className="text-xs text-white text-center">{t("common:categories")}</p>
        </button>
        <Link
          href="/"
        ...
        >
          ...
          <p className="text-xs text-white text-center">{t("common:home")}</p>
        </Link>
        ...
        >
          <div className="relative whitespace-nowrap inline-flex items-center justify-center text-white text-lg">
          ...
          <p className="text-xs text-white text-center pl-1">{t("common:cart")}</p>
        </button>
        <button
          aria-label="User"
          type="button"
        ...
        <a href="https://api.whatsapp.com/send/?phone=972525123003"
          target="_blank"
          className="flex flex-col gap-1 items-center justify-center text-xl text-white">
          <span>
            <BsWhatsapp className="w-6 h-6 drop-shadow-xl" />
          </span>
          <p className="text-xs text-white text-center">{t("common:contactUs")}</p>
        </a>
      </footer>
    </>
  );
