...
const Footer = () => {
  ...
  const reasonToStay = storeCustomizationSetting?.footer?.social_links_status || storeCustomizationSetting?.footer?.bottom_contact_status || storeCustomizationSetting?.footer?.payment_method_status;

  return (
    <div className="pb-16 lg:pb-0 xl:pb-0 bg-white">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10">
        <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-10 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 lg:py-16 justify-between">
          {storeCustomizationSetting?.footer?.block1_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-2">
          ...
          {storeCustomizationSetting?.footer?.block2_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-2">
              ...
              <ul className="text-sm lg:text-15px flex flex-col space-y-3">
                ...
                {storeCustomizationSetting?.footer?.block2_sub_title5 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block2_sub_link5}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block2_sub_title6 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block2_sub_link6}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block2_sub_title7 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block2_sub_link7}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
          ...
          {storeCustomizationSetting?.footer?.block3_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-2">
              ...
              <ul className="text-sm lg:text-15px flex flex-col space-y-3">
                ...
                {storeCustomizationSetting?.footer?.block3_sub_title5 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block3_sub_link5}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block3_sub_title6 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block3_sub_link6}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block3_sub_title7 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block3_sub_link7}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
          ...
          {storeCustomizationSetting?.footer?.block5_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-2">
              <h3 className="text-md lg:leading-7 font-medium mb-4 sm:mb-5 lg:mb-6 pb-0.5">
                <CMSkeleton
                  count={1}
                  height={20}
                  loading={loading}
                  data={storeCustomizationSetting?.footer?.block5_title}
                />
              </h3>
              <ul className="text-sm lg:text-15px flex flex-col space-y-3">
                {storeCustomizationSetting?.footer?.block5_sub_title1 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block5_sub_link1}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block5_sub_title2 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block5_sub_link2}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block5_sub_title3 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block5_sub_link3}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block5_sub_title4 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block5_sub_link4}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
                ...
                {storeCustomizationSetting?.footer?.block5_sub_title5 && (
                  <li className="flex items-baseline">
                    <Link
                      href={`${storeCustomizationSetting?.footer?.block5_sub_link5}`}
                      className="text-gray-600 inline-block w-full hover:text-customRed"
                    >
                      <CMSkeleton
                        count={1}
