...
const PickupMsgModal = ({ closeModal = () => { } }) => {
  ...
  // התאמת ההודעה בהתאם לשעה (אם לפני או אחרי 16:00)
  let now = dayjs();
    ...
    <div className="w-52">
      ...
      <div className="flex flex-col justify-center gap-3">
        <p className="text-center text-lg">
          {currentHour < 16 ? t("common:PickupMessagePart1") + "(" + formattedDate + ")" + ", " + t("common:PickupMessagePart2") : t("common:PickupMessagePart3") + "(" + formattedDate + ")" + ", " + t("common:PickupMessagePart2")}
        </p>
