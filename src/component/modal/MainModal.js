              ...
              <div className="inline-block overflow-hidden text-left align-middle transition-all transform bg-white rounded-2xl xl:max-w-6xl shadow-popup">
                ...
                <div className="absolute right-5 top-5">
                  <button
                    ...
                    onClick={handleClose}
                    type="button"
                    className="inline-flex justify-center px-2 py-2 text-base font-medium text-white border border-transparent rounded-full bg-customRed-leaf focus:outline-none border-none outline-none"
                  >
                    <IoClose />
                  </button>
                </div>
