  ...
  setting: {
    ...
    home: {
      ...
      quick_delivery_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our אחים שפירא shop and get some special offers. See Our latest discounted products from here and get a special discount.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem אחים שפירא-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
      },
      ...
      daily_need_title: {
        en: "Get Your Daily Needs From Our אחים שפירא Store",
        de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
      },
      daily_need_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our אחים שפירא shop and get some special offers.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem אחים שפירא-Shop und erhalten Sie einige Sonderangebote.",
      },
    ...
    about_us: {
      ...
      top_title: {
        en: "Welcome to our אחים שפירא shop",
        de: "Willkommen in unserem אחים שפירא-Shop",
      },
      top_description: {
    ...
    contact_us: {
      ...
      email_box_email: {
        en: "info@אחים שפירא.com ",
        de: "info@אחים שפירא.com",
      },
      email_box_text: {
    ...
    faq: {
      ...
      faq_one: {
        en: "How does the אחים שפירא work?",
        de: "Wie funktioniert der אחים שפירא?",
      },
      description_one: {
      ...
      faq_five: {
        en: "What is אחים שפירא EC2 auto scaling?",
        de: "Was ist die automatische Skalierung von אחים שפירא EC2?",
      },
      description_five: {
        en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
      ...
      faq_six: {
        en: "What are the benefits of using אחים שפירא affliate?",
    ...
    seo: {
      ...
      meta_title:
        "אחים שפירא - React Grocery & Organic Food Store e-commerce Template",
      meta_url: "https://אחים שפירא-store-nine.vercel.app/",
    },
  },
