        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="elementor-element elementor-element-378a75c8 elementor-widget elementor-widget-text-editor" data-id="378a75c8" data-element_type="widget" data-widget_type="text-editor.default">
            <div className="elementor-widget-container">
              ...
              <div>
                <p>אנו בחברת משק קירשנר מחוייבים למתן שוויון הזדמנויות לאנשים עם צרכים מיוחדים. ולפיכך עיצבנו ותכננו את האתר לעמוד בהנחיות הנגישות. האתר של משק קירשנר עומד בדרישות תקנות שיוויון זכויות לאנשים עם מוגבלות (התאמות נגישות לשירות), התשע”ג 2013.</p>
                ...
                <p>פרטי רכז הנגישות מטעם משק קירשנר:</p>
