  ...
  const handleAddItem = (product, quantity) => {
    ...
    if (result !== undefined) {
      ...
      // ) {
        ...
        notifySuccess(`${item} ${product.ItemName ? product.ItemName : currentLang ? product.title?.he : product.title?.en} ${t("common:addedToCart!")}`);
      // } else {
      ...
      // ) {
        ...
        quantity ? '' : notifySuccess(`${item} ${product.ItemName ? product.ItemName : currentLang ? product.title?.he : product.title?.en} ${t("common:addedToCart!")}`);
      // } else {
      //   notifyError(t("common:productStockOut"));
      // }
    }
